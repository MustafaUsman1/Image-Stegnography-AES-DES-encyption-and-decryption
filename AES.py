...
#encypting
#read chumi.jpg
#img = cv2.imread('encoded_logo.png')
img = cv2.imread('stegoPineapple.png')
...
cv2.imwrite('AESencrypted.png', I5)


# decryption
# decrypt chumi_encrypted.jpg
plaintext = decrypt(nonce, ciphertext, tag)
f = open("AESdencrypted.txt", "wb")
f.write(plaintext)
f.close()
...
cv2.imwrite('AESdencrypted.png', I3)
V = cv2.imread('encrypted.png')
